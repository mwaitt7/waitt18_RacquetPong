 ...
 * Animator.
 *
 * NOTE: Even though the instructions for this assignment said we should
 * not touch this class, I touched it anyway. The few modifications that I
 * made are signified by a large arrow in the right margin.
 *
...
public class AnimationSurface extends SurfaceView implements OnTouchListener {
    ...
    private String titleString = "RacquetPong 2k16"; //String symbolizing title of game <------------
     ...
     */
    public void setAnimator(AnimationTest animator) {
    ...
    private class AnimationThread extends Thread {
        ...
        public void run() {
            ...
            while (threadIsRunning) {
                ...
                borderPaint.setColor(Color.rgb(255, 215, 0));//<--------------------------------
                /**
                 External Citation
                 Date: 22 February 2016
                 Problem: Did not know how to draw an unfilled rectangle
                 Resource:
                 http://stackoverflow.com/questions/10604018/how-to-
                 draw-unfilled-circle-and-rectangle-on-android
                 Solution: Used Paint.setStyle(Style.STROKE)
                 */
                ...
                try {
                    ...
                    if (canvas != null) {
                        ...
                        if (flashCount > 0) {
                            ...
                            canvas.drawLine(45f, 45f, getWidth() - 45, 45f, borderPaint);//<--------------------------------
                            canvas.drawLine(getWidth()-45, getHeight()-85, getWidth()-45, 35f, borderPaint);//<--------------------------------
                            canvas.drawLine(45f, getHeight() - 85, 45f, 35f, borderPaint);//<--------------------------------
                            textPaint.setTextSize(120);//<--------------------------------
                            /**
                             External Citation
                             Date: 24 February 2016
                             Problem: Did not know how to make text bigger
                             Resource:
                             http://stackoverflow.com/questions/2655402/android-canvas-drawtext
                             Solution: Used Paint.setTextSize()
                             */
                            textPaint.setFakeBoldText(true);//<--------------------------------
                            canvas.drawText(titleString, (float)getWidth()/2-480,(float)getHeight()/5, textPaint);//<--------------------------------
                        }
